...
var key_up = (isAllowedToGrapple) ? keyboard_check(ord("W")) : 0;
var key_left = keyboard_check(ord("A"));
var key_right = keyboard_check(ord("D"));
var key_space = keyboard_check(vk_space);
//var key_down = keyboard_check(ord("S"));
var mouse_left = (isAllowedToGrapple) ? mouse_check_button_pressed(mb_left) : 0;
var mouse_right = (isAllowedToGrapple) ? mouse_check_button_pressed(mb_right) : 0;
